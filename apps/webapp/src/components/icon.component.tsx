...
const ICON_CLASSES = {
  ...
  import: iconsStyles.import,
  info: iconsStyles.info,
  memorize: iconsStyles.memorize,
  navigate: iconsStyles.navigate,
  new: iconsStyles.new,
  newPlay: iconsStyles.newPlay,
  next: iconsStyles.next,
